...
export interface ApiAnonymousUserAnonymousUser
  extends Struct.CollectionTypeSchema {
  collectionName: 'anonymous_users';
  info: {
    displayName: 'AnonymousUser';
    pluralName: 'anonymous-users';
    singularName: 'anonymous-user';
  };
  options: {
  ...
  attributes: {
    ...
    convertedToUser: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiChatbotConversationChatbotConversation
  extends Struct.CollectionTypeSchema {
  collectionName: 'chatbot_conversations';
  info: {
    description: '';
    displayName: 'Chatbot Conversation';
    pluralName: 'chatbot-conversations';
    singularName: 'chatbot-conversation';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::chatbot-conversation.chatbot-conversation'
    > &
      Schema.Attribute.Private;
...
export interface ApiFitnessPlanFitnessPlan extends Struct.CollectionTypeSchema {
  collectionName: 'fitness_plans';
  info: {
    description: '';
    displayName: 'Fitness Plan';
    pluralName: 'fitness-plans';
    singularName: 'fitness-plan';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiInterpretationInterpretation
  ...
  info: {
    ...
    pluralName: 'interpretations';
    singularName: 'interpretation';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    niveau: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    results: Schema.Attribute.Relation<'oneToMany', 'api::result.result'>;
    scoreMax: Schema.Attribute.Integer;
    scoreMin: Schema.Attribute.Integer;
    teste: Schema.Attribute.Relation<'manyToOne', 'api::teste.teste'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMentalExerciseMentalExercise
  extends Struct.CollectionTypeSchema {
  collectionName: 'mental_exercises';
  info: {
    displayName: 'Mental Exercise';
    pluralName: 'mental-exercises';
    singularName: 'mental-exercise';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::mental-exercise.mental-exercise'
    > &
      Schema.Attribute.Private;
...
export interface ApiMentalMental extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mental_exercises: Schema.Attribute.Relation<
      'oneToMany',
      'api::mental-exercise.mental-exercise'
    >;
...
export interface ApiPersonalizedDietPersonalizedDiet
  ...
  info: {
    description: '';
    displayName: 'Personalized Diet';
    pluralName: 'personalized-diets';
    singularName: 'personalized-diet';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date;
    diet_plan: Schema.Attribute.JSON;
    image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    reponses: Schema.Attribute.Relation<'manyToMany', 'api::reponse.reponse'>;
    teste: Schema.Attribute.Relation<'manyToOne', 'api::teste.teste'>;
...
export interface ApiRecipeRecipe extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    dietary_tags: Schema.Attribute.Enumeration<
      [
        'Protein',
        'Gluten Free',
        'Vegetarian',
...
export interface ApiResultResult extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date;
    interpretation: Schema.Attribute.Relation<
      'manyToOne',
      'api::interpretation.interpretation'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiTestScoreTestScore extends Struct.CollectionTypeSchema {
  collectionName: 'test_scores';
  info: {
    displayName: 'TestScore';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date: Schema.Attribute.Date;
    interpretation: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiTesteTeste extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    image: Schema.Attribute.Media<
      ...
      true
    >;
    interpretations: Schema.Attribute.Relation<
      'oneToMany',
      'api::interpretation.interpretation'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    anonymous_user: Schema.Attribute.Relation<
      'oneToOne',
      'api::anonymous-user.anonymous-user'
    >;
    blocked: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    chatbot_conversation: Schema.Attribute.Relation<
      'oneToOne',
      'api::chatbot-conversation.chatbot-conversation'
    >;
    ...
    > &
      Schema.Attribute.Private;
    mode_invite: Schema.Attribute.Boolean;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
      }>;
    personalized_diet: Schema.Attribute.Relation<
      'oneToOne',
      'api::personalized-diet.personalized-diet'
    >;
